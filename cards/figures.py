...
FIGURE_CARDS = {
    ...
    202: FigureCard(202, "queen", "Open own W: self +1 HP and opponent -1 HP once per turn", ("WOWOW", "OWWWO", "WWQWW", "OWWWO", "WOWOW"), False),
    203: FigureCard(203, "bishop", "Open own W: self +0.5 HP and opponent -0.5 HP once per turn", ("WOOOW", "OWOWO", "OOBOO", "OWOWO", "WOOOW"), False),
    204: FigureCard(204, "knight", "Open own W: self +0.5 HP and opponent -0.5 HP once per turn", ("OWOWO", "WOOOW", "OOKOO", "WOOOW", "OWOWO"), False),
    205: FigureCard(205, "rook", "Open own W: self +0.5 HP and opponent -0.5 HP once per turn", ("OOWOO", "OOWOO", "WWRWW", "OOWOO", "OOWOO"), False),
